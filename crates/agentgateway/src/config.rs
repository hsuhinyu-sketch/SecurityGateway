...
use crate::{
	...
	RawLoggingLevel, StringOrInt, ThreadingMode, cel, client, serdes, telemetry, types,
};
...
pub fn parse_config(
	...
	let local_config = local_config_source;
	...
	// Standalone mode has no workload-discovery service. When identity metadata is available,
	// use it directly for locality-aware load balancing.

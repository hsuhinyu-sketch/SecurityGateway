...
pub enum BackendTrafficPolicy {
	...
	SecurityPipeline(Arc<gateway_adapter::SecurityPipelineConfig>),
	SecurityAudit(Arc<security_integration_agentgateway::SecurityConfig>),
	A2a(A2aPolicy),
	#[serde(rename = "http")]
	HTTP(backend::HTTP),
	#[serde(rename = "tcp")]
...
// Local configuration for MCP authentication
#[apply(schema_de!)]
